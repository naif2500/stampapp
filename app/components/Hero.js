...
export default function HeroSection() {
  return (
    <section className="bg-gradient-to-bl from-[#81B97B] via-[#385C32] to-[#5B8B54] text-white rounded-2xl p-4">
      <NavbarInverted />
      <div className=" mx-auto flex flex-col-reverse md:flex-row items-center px-12 py-16 space-y-10 md:space-y-0">
        
        {/* Left Content */}
        <div className="flex-1 space-y-6">
          <h1 className="font-unbounded text-4xl md:text-5xl font-bold leading-tight"  style={{ fontFamily: 'var(--font-unbounded)' }}>
