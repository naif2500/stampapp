  ...
  return (
    ...
    background: "linear-gradient(to bottom left, #81B97B 0%, #385C32 40%, #385C32 70%, #5B8B54 100%)"
      ...
      <div className="mx-auto flex flex-col-reverse md:flex-row items-center px-12 py-16 space-y-10 md:space-y-0">
        ...
        >
          <h1
            className="font-unbounded text-4xl md:text-5xl font-bold leading-tight"
        ...
        {/* Right Image */}
        <motion.div
          className="-mb-20 flex-1 flex justify-center relative w-full h-[400px] md:h-[550px] overflow-hidden"
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
